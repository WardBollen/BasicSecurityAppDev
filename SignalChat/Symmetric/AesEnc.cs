...
namespace Symmetric
{
    class AesEnc
    {
        ...
        {
            string dataToEncrypt = "Here is some data to encrypt!";
            ...
            using (Aes myAes = Aes.Create())
            {
                ...
                byte[] encrypted = EncryptStringToBytesAes(dataToEncrypt, myAes.Key, myAes.IV);

                // Decrypt the bytes to a string.
                string roundtrip = DecryptStringFromBytesAes(encrypted, myAes.Key, myAes.IV);

                //Display the original data and the decrypted data.
                Console.WriteLine("Original:   {0}", dataToEncrypt);
